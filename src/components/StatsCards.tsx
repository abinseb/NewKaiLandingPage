...
const statsData = [
  {
    ...
    description: 'AI-driven analysis for proposal evaluation and ranking',
    icon: '🎯'
  },
  {
    number: 24,
    suffix: '/7',
    title: 'New Ideas ',
    description: 'AI-assisted idea generation and proposal submission',
    icon: '⚡'
  },
  {
    number: 1000,
    ...
    description: 'AI-generated proposals for public policy and services',
    icon: '🧠'
  }
];
