      ...
      <div className="container mx-auto max-w-7xl">
        ...
        >
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Explore Our <span className="text-kai-cyan">Departments</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
          {departments.map((department, index) => (
            <Card 
              key={department.id}
              className={`bg-white/95 border border-gray-200 hover:border-kai-cyan/60 transition-all duration-500 hover:shadow-xl hover:shadow-kai-white hover:-translate-y-1 ${
            ...
            >
              <CardContent className="p-5 text-center">
                ...
                <CardTitle className="text-gray-800 text-base font-semibold  leading-tight">
                  {department.name}
                </CardTitle>
